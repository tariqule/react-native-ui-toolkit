...
class ScrollableTabView extends React.Component<ScrollableTabViewProps, State> {
  ...
  constructor(props: ScrollableTabViewProps) {
    ...
    const scrollValue = new Animated.Value(
      (initialPage * deviceWidth) / deviceWidth
    );
  ...
  keyExists = (sceneKeys: string[], key: string) =>
  ...
  children = (children = this.props.children) => {
    return (
      React.Children.map(children, (child: ReactChildMapType) => child) ?? []
    );
  };
  ...
  renderScrollableContent() {
    ...
    return (
      <Animated.ScrollView
        ...
        ref={(
          scrollView: ScrollView | Animated.LegacyRef<ScrollView> | null
        ) => {
