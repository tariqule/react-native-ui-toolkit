...
import { ScrollableTabBar, HeaderBackgroundImage } from './components';
...
class StickyParallaxHeaderComponent extends Component<
...
> {
  ...
  componentDidUpdate(
    _prevProps: Readonly<StickyParallaxHeaderProps>,
    prevState: Readonly<State>
  ) {
    const { headerHeight, parallaxHeight, tabs, rememberTabScrollPosition } =
      this.props;
  ...
  renderForeground = (backgroundHeight: number) => {
    const { foreground, tabsContainerBackgroundColor, backgroundImage } =
      this.props;
  ...
  render() {
    ...
    const innerScrollHeight =
      Dimensions.get('window').height - headerHeight - parallaxHeight;
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <ScrollableTabView
            ...
            onScrollXIOS={(x: any) => this.scrollXIOS.setValue(x)}
            contentContainerStyles={contentContainerStyles}
            initialPage={initialPage}
            onChangeTab={(i: any) => this.onChangeTabHandler(i)}
            page={currentPage}
